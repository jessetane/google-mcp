...
* **Presets**: Quick-select buttons are available for **Recommended** (all standard personal Google services, excluding enterprise/Workspace scopes), **All Read-Only**, **All Write**, and **None**.  
* **Enterprise Scopes**: Scopes marked with `**` (Google Keep, Meet, Chat) require an Enterprise or Google Workspace account and will fail if requested from a personal (`@gmail.com`) account.  
